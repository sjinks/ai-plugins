...
6. Check traceability after changes. Every hardened requirement, decision, or test should point back to user scope, FR/NFR/AC/interface, risk, edge case, or an explicit assumption.
